...
const SleepImpactScreen = ({ value, onNext }: { value: string; onNext: (val: string) => void }) => {
  ...
  return (
    ...
    >
      ...
      >
        69% of users say Dr. Cuterus helps them sleep better.
      </motion.p>
      ...
      >
        Does your cycle impact your sleep?
      </motion.h2>
...
export default SleepImpactScreen;
